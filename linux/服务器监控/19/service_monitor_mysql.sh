...
function check_disk(){
	...
	do
		...
		insert_table="insert into message  (disk) values ('3')"
		insert_tables
		send_mail
		echo "发送邮件 磁盘触发"        
		fi
...
function check_redis(){
	...
	insert_table="insert into message  (redis) values ('1')"
	insert_tables
	send_mail
	else
...
function check_jboss(){
	...
	insert_table="insert into message  (jboss) values ('1')"
	insert_tables
	send_mail
	else
...
function check_mysql(){
	...
	insert_table="insert into message  (mysql) values ('1')"
	insert_tables
	send_mail
	else
...
function check_nginx(){
	...
	insert_table="insert into message  (nginx) values ('1')"
	insert_tables
	send_mail
	else
...
function check_redis_mem() {
	...
	insert_table="insert into message  (redis) values ('3')"
	insert_tables
	send_mail
	else
...
function check_mysql_log(){
	...
	insert_table="insert into message  (mysql_log) values ('2')"
	insert_tables
	send_mail
	fi
}
function check_nginx_log(){
	...
	insert_table="insert into message  (nginx_log) values ('2')"
	insert_tables
	send_mail	
	fi
...
function check_jboss_log(){
	...
	insert_table="insert into message  (jboss_log) values ('2')"
	insert_tables
	send_mail
	fi	
